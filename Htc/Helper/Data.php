...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getGeneralConfig($field){
        $result = $this->_scopeConfig->getValue('htc/general/'.$field, $this->_storeScope);
        return $result;
    }

    public function getStoreConfig($field){
        $result = $this->_scopeConfig->getValue('htc/stores/'.$field, $this->_storeScope);
        return $result;
    }
}
