...
namespace Project\Google\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getGeneralConfig($field){
        $result = $this->_scopeConfig->getValue('google/general/'.$field, $this->_storeScope);
        return $result;
    }

    public function getStoreConfig($field){
        $result = $this->_scopeConfig->getValue('google/stores/'.$field, $this->_storeScope);
        return $result;
    }
}
